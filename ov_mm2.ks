...
FUNCTION MM2_DOCK_TASK { PARAMETER DT.
	IF MINOR_MODE = 2 {
		...
		TASK_SCHEDULE(16, MM2_DOCK_TASK@).
	}
...
FUNCTION MM2_RENDEZVOUS_TASK { PARAMETER DT.
	IF MINOR_MODE = 7 {
		...
		TASK_SCHEDULE(16, MM2_RENDEZVOUS_TASK@).
	}
...
FUNCTION MM2_TARGET_TRACK_TASK { PARAMETER DT.
	IF MINOR_MODE = 6 {
		...
		TASK_SCHEDULE(16, MM2_TARGET_TRACK_TASK@).
	}

	IF HASTARGET {
		SET REL_POSITION 		TO TARGET:POSITION - SHIP:POSITION.
		SET REL_POSITION_SHIP	TO (-SHIP:FACING) * REL_POSITION.
		SET CURRENT_STEERING	TO ((ANGLEAXIS(0, REL_POSITION)*R(0,0,-MM2_DOCK_DR))*R(-MM2_DOCK_DP,0,0))*R(0,-MM2_DOCK_DY,0).
	}
}
...
MODE_TASK		(2, MM2_DOCK_TASK@).
MODE_TASK		(2, MM2_RENDEZVOUS_TASK@).
MODE_TASK		(2, MM2_TARGET_TRACK_TASK@).

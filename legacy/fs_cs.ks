...
SET MM1_CUTOFF_PER		TO 75000.	// CUTOFF PERIAPSIS

// MAJOR MODE 3
SET MM3_TARGET_SPEED	TO 140.		// NOMINAL PRE-LANDING SPEED
SET MM3_GLIDE_ALT		TO 50.		// ALTITUDE OF TRANSITION TO 1 M/S GLIDE
...
SET RUNWAY				TO LATLNG(-0.0486, -74.6848 - 0.15). //74.4970 other end

// MAJOR MODE 6
SET MM6_BURN_DISTANCE	TO 1000000.	// REENTRY BURN DISTANCE
SET MM6_ROLL_REV_SPEED	TO 6.		// MAXIMUM ROLL COMMAND SPEED (DEG/SEC) 6 FOR CS

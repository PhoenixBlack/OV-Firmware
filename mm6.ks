...
FUNCTION MAJOR_MODE6_TRANSFER {
	...
	SET VDRAG_CONTROLLER TO PIDLOOP(2.000,	0.000,	2.000,	-15.0,	15.0).
...
FUNCTION MAJOR_MODE6 {
	...
	// GET CURRENT DRAG
	SET DRAG_CUR TO DRAG_CUR*0.6 + 0.4*MIN(-0.01, -SHIP:SENSORS:ACC:MAG).

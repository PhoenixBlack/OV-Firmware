...
FUNCTION TASK_UI_SYSTEMS_SCREENS { PARAMETER DT.
	...
	UI_VARIABLE("   R",	"M",	SHIP:ALTITUDE/1000,		0,8, SIGNED,	32,5).
	UI_VARIABLE("  AP",	"M",	SHIP:APOAPSIS/1000,		0,8, SIGNED,	32,6).
	UI_VARIABLE("  PE",	"M",	SHIP:PERIAPSIS/1000,	0,8, SIGNED,	32,7).
